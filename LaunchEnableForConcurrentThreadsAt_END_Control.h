...
namespace Avril_FSD
{
    ...
    public:
        ...
        void LaunchEnable_Request(class LaunchEnableForConcurrentThreadsAt_END_Framework* obj, unsigned char concurrent_CoreId);
        void LaunchEnable_SortQue(class LaunchEnableForConcurrentThreadsAt_END_Framework* obj, unsigned char number_Implemented_Cores);
        void LaunchQue_Update(class LaunchEnableForConcurrentThreadsAt_END_Framework* obj, unsigned char number_Implemented_Cores);
    ...
    private:
        void DynamicStagger(class LaunchEnableForConcurrentThreadsAt_END_Framework* obj, unsigned char coreId);
        void LaunchEnable_ShiftQueValues(class LaunchEnableForConcurrentThreadsAt_END_Framework* obj, unsigned char concurrent_CoreId_A, unsigned char concurrent_CoreId_B);
